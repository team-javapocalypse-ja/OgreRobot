package javapocalypse.core.api.config;
...
@EnableJpaRepositories("javapocalypse.core.model.repositories")
...
public class DataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("javapocalypse.core.model.entities");
